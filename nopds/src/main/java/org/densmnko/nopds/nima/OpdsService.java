...
public class OpdsService implements HttpService {
    ...
    public void routing(HttpRules httpRules) {
        httpRules.get("/opds", this::root);
        httpRules.get("/opds/{uuid}", this::byUuid);
    }

    private void byUuid(ServerRequest serverRequest, ServerResponse serverResponse) throws IOException {
    ...
    private void root(ServerRequest serverRequest, ServerResponse serverResponse) throws IOException {
        serverResponse.header(CONTENT_TYPE_TEXT_XML);
        final OutputStream outputStream = serverResponse.outputStream();
        outputStream.write(("<feed xmlns=\"http://www.w3.org/2005/Atom\"\n" +
                "      xmlns:dc=\"http://purl.org/dc/terms/\"\n" +
